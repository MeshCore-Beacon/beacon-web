...
export function FilterBar({
  ...
  return (
    <div
      className="flex items-center gap-1.5 px-4 py-[7px] border-b border-border-subtle bg-bg-base"
      role="toolbar"
    ...
    >
      ...
      {hasFilters && (
        <button
          type="button"
          className="text-[11px] font-mono text-text-dim hover:text-danger px-1.5 py-[2px] cursor-pointer transition-colors"
          onClick={onClear}
        >
          Clear
        </button>
