...
export function DrawerSection({ title, children, first }: { title: string; children: React.ReactNode; first?: boolean }) {
  return (
    <div className={`px-3 py-2.5 ${first ? "" : "border-t border-border-subtle"}`}>
      <div className="text-[12px] font-mono font-medium text-text-bright uppercase tracking-wider mb-1.5">{title}</div>
      {children}
    </div>
  );
}
...
export function HeaderBitBreakdown({ headerHex }: { headerHex: string }) {
  ...
  return (
    <div className="mt-1.5 font-mono text-[12px] bg-bg-base border border-primary/20 rounded px-2 py-1.5">
  ...
  return (
    <div className="flex flex-col gap-1.5 font-mono text-[13px]">
      <div className="flex items-center gap-2">
        ...
        <span className="text-primary font-semibold text-[13px] bg-primary/6 px-1.5 py-[1px] rounded-sm">
          {observation.iata}
        </span>
      ...
      {observation.radio && (
        <div className="flex items-center gap-1.5 text-[13px] text-text-muted">
          <span className="text-text-dim text-[12px] font-medium uppercase tracking-wider mr-0.5">Radio</span>
      ...
      {observation.resolvedPath.length > 0 && (
        <div className="flex flex-wrap items-center gap-1 text-[13px] pt-1 border-t border-border-subtle">
          <span className="text-text-dim text-[12px] font-medium uppercase tracking-wider mr-1">Path</span>
