  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 mt-1 pl-6 text-[11px] text-text-dim">
        <span className="font-mono text-[11px] text-text-muted uppercase tracking-wider bg-text-muted/8 px-1.5 py-[1px] rounded-sm">
      ...
      {expanded && detail && (
        <div className="mt-2 pl-6 flex flex-col gap-[3px]" onClick={(e) => e.stopPropagation()}>
