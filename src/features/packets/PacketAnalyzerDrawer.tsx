  ...
  if (!open) {
    return (
      <div className="shrink-0 w-8 border-l border-border bg-bg-surface flex flex-col items-center">
        ...
        {detail && (
          <div className="mt-3 writing-vertical text-[12px] font-mono font-medium text-text-dim tracking-wider">
            ...
            <DrawerSection title="Packet Structure">
              <div className="flex flex-col gap-2.5 font-mono text-[13px]">
                ...
                <ColorAccentField field="header">
                  <div className="text-text-dim text-[12px] font-medium uppercase tracking-wider mb-1">Header Byte</div>
                ...
                {selectedObs && (
                  <ColorAccentField field="pathLength">
                    <div className="text-text-dim text-[12px] font-medium uppercase tracking-wider mb-1">Path Length</div>
                    <div className="flex gap-x-4">
                ...
                {selectedObs?.pathBytes && (
                  <ColorAccentField field="pathData">
                    <div className="text-text-dim text-[12px] font-medium uppercase tracking-wider mb-1">Path Data</div>
                      ...
                      {(() => {
                        ...
                        return hops.map((hop, i) => (
                          <span key={i} className="contents">
                            ...
                            <span className="px-1.5 py-[1px] rounded-sm bg-primary/6 text-primary font-semibold">{hop.toUpperCase()}</span>
                          </span>
                        ));
                      })()}
                    </div>
                ...
                {detail.originPubkey && detail.payloadType !== PayloadType.ADVERT && (
                  <ColorAccentField field="payload">
                    <span className="text-text-dim text-[12px] font-medium uppercase tracking-wider">Origin Pubkey</span>
